# 🤝 Contribuindo para o Full Finanças
...
1. **Verifique se o bug já foi reportado** - Procure nas issues existentes no repositório do projeto
...
1. **Verifique se a funcionalidade já foi sugerida** - Procure nas issues existentes no repositório do projeto
2. **Crie uma nova issue** com:
...
- **Mantenedor**: Victor Alves
- **Issues**: use o repositório Git do projeto
